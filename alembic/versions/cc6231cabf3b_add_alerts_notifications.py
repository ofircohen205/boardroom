...
def upgrade() -> None:
    ...
    op.create_index('ix_price_alerts_ticker_active', 'price_alerts', ['ticker', 'active'])
    op.create_index('ix_price_alerts_triggered_active', 'price_alerts', ['triggered', 'active'])
