...
def upgrade() -> None:
    ...
    action_enum = postgresql.ENUM(
        "BUY", "SELL", "HOLD", name="action", create_type=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "market",
            postgresql.ENUM("US", "IL", name="market", create_type=False),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "action",
            postgresql.ENUM("BUY", "SELL", "HOLD", name="action", create_type=False),
            nullable=False,
        ),
