...
from backend.shared.core.cache import cached
...
def get_market_data_client(
    ...
    match provider:
        case MarketDataProvider.YAHOO:
            ...
            if settings.alpha_vantage_api_key.get_secret_value():
        ...
        case MarketDataProvider.ALPHA_VANTAGE:
            return AlphaVantageClient(settings.alpha_vantage_api_key.get_secret_value())
